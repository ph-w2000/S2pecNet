...
class ResNet(nn.Module):
    def __init__(self, num_nodes, enc_dim, resnet_type='18', nclasses=2):
        ...
        self.conv1 = nn.Conv2d(1, 8, kernel_size=(3, 9), stride=(1, 3), padding=(1, 1), bias=False)
        ...
        self.conv5 = nn.Conv2d(64 * block.expansion, 64, kernel_size=8, stride=(1, 1), padding=0,
                               bias=False)
        self.bn5 = nn.BatchNorm2d(64)
        self.fc = nn.Linear(117, 29)
